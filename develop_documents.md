...
删除： 
1. 单机某一个文件夹/文件`更多icon`
2. 显示下拉菜单选项
3. 单机删除

```vue
//1. 给activeId/hover的文件加上更多icon

//2. 单机之后出现：刷新、复制链接、复制、剪切、重命名、删除的下拉dropdown

//3. 单机删除之后，弹出提示modal，删除对应的file或者documents
